...
describe('bankAccount', () => {
  ...
  test('depositMoney should correctly add to the balance', () => {
    ...
    expect(bankAccount.balance).toEqual(originalBalance + 500);
  });

  test('withdrawMoney should correclty subtract from the balance', () => {
    const originalBalance = bankAccount.balance;
    bankAccount.withdrawMoney(500);
    expect(bankAccount.balance).toEqual(originalBalance - 500);
  });

  test('widthrawMoney should not allow withdrawals exceeding the balance', () => {
